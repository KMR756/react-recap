     ...
     lg:flex-row ">
      <div className="bg-zinc-900 lg:w-1/2 h-fit rounded-2xl">
        <form onSubmit={submitHandler} className="flex items-center p-20 flex-col ">
          <input className="border-2 text-6xl rounded-2xl my-10" type="text" placeholder="Enter Note" />
          <textarea className="h-40 border-2 w-full rounded-2xl text-4xl p-2 my-2" name="" placeholder="Enter Details" id=""></textarea>
